...
const STATUS_MAP = {
  ...
  PAID: {
    label: "Pagada",
    dot: "bg-green-400",
    pill: "bg-green-50 text-green-700 ring-green-200/60"
  },
  CANCELLED: {
    label: "Cancelada",
    dot: "bg-gray-300",
    pill: "bg-gray-50 text-gray-500 ring-gray-200/60"
  },
  EXPIRED: {
    label: "Expirada",
    dot: "bg-gray-400",
    pill: "bg-gray-100 text-gray-500 ring-gray-200/60"
  }
};
...
const getTimeLeft = (createdAt, pendingExpirationMinutes) => {
  if (!createdAt || !pendingExpirationMinutes) return null;

  const created = new Date(createdAt).getTime();

  const expiresAt =
    created + pendingExpirationMinutes * 60 * 1000;
...
export default function MyReservations() {
  ...
  const handlePay = (r) =>
    navigate("/payment", {
      state: {
        ...
        filters: {
          date: fmt(r.startAt, "date"),
          start: fmt(r.startAt, "time"),
          end: fmt(r.endAt, "time")
        },
        total: r.price,
  ...
  /*
   * Primero esperamos la configuración porque
   * el contador de reservas pendientes depende de ella.
   */
        ...
        <div className="max-w-7xl mx-auto px-8">
          ...
          <div className="mb-6 pt-2">
            ...
            <p className="text-sm text-gray-400 mt-0.5">
              ...
              {reservations.length !== 1 ? "s" : ""} en total
            </p>
          </div>
              ...
              {TABS.map((t) => {
                ...
                return (
                  ...
                  >
                    {t !== "ALL" && (
                      <span
                        className={`w-1.5 h-1.5 rounded-full shrink-0 ${s?.dot ?? "bg-gray-300"
                          }`}
                      />
                    )}
            ...
            <div className="flex flex-col items-center py-24 gap-3 text-center">
              ...
              <p className="text-sm text-gray-400 max-w-xs">
                {tab === "ALL"
                  ...
                  : `Sin reservas con estado "${STATUS_MAP[tab]?.label ?? tab
                  }".`}
              </p>
          ...
          {!loading && list.length > 0 && (
            <div className="flex flex-col gap-2.5">
              ...
              {list.map((r, i) => {
                ...
                /*
                 * El tiempo de expiración ahora viene
                ...
                return (
                  ...
                  >
                      ...
                      <div className="flex flex-wrap items-center gap-x-4 gap-y-1.5 mt-3">
                        ...
                        <span className="flex items-center gap-1.5 text-[13px] text-gray-500">
                          ...
                          >
                            ...
                            <path
                              d="M4.5.7v1.5M9.5.7v1.5M.7 5.2h12.6"
                              stroke="currentColor"
                              strokeWidth="1.1"
                              strokeLinecap="round"
                            />
                        ...
                        <span className="ml-auto text-[15px] font-bold text-gray-900">
                          ${r.price}
                        </span>
                    ...
                    {/* Actions */}
                    {(canPay || canCancel) && (
                      <div className="flex justify-end gap-2 px-5 py-3 border-t border-gray-50 bg-gray-50/50">
